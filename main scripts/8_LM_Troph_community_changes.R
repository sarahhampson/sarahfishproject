...
comms_troph_data_list <- find.commS.trait.data(comms, taxonomic_matrix_list, trait_data, "troph_level")
...
# 4.  Save community troph dataframe ---------------------------------------
...
# Save the dataframes
write.csv(tax_troph_plot_df, "./outputs/MBl/tax_lm_troph.csv")
write.csv(tax_Abtroph_plot_df, "./outputs/MBl/tax_lm_Abtroph.csv")
write.csv(tax_sdtroph_plot_df, "./outputs/MBl/tax_lm_sdtroph.csv")
write.csv(func_troph_plot_df, "./outputs/MBl/func_lm_troph.csv")
write.csv(func_Abtroph_plot_df, "./outputs/MBl/func_lm_Abtroph.csv")
write.csv(func_sdtroph_plot_df, "./outputs/MBl/func_lm_sdtroph.csv")
...
rm(full_results_df, trait_data, taxonomic_matrix_list, survey_data, ts_data, 
   ...
   full_results_df_troph, full_results_df_Abtroph, comms)
