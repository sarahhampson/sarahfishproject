figure1B.plot <- function(prob.model.list,
  ...
  # Wrap around model predictions for novelty probs
  ...
  text(x=c(circle.cent + c(-0.075, 0.085, 0.01)),
       ...
       font=2, cex=0.9) # THIS DOES THE MEANS for all 3 cats
  
  # THIS DOES THE CONFIDENCE INTERVALS for all 3 cats
    ...
    # relative axis point converts x y points into percentages (changing lims, code puts them in same place)
